...
from diamond_miner.mappers import SequentialFlowMapper,RandomFlowMapper
...
def probe_generator_parallel(
    ...
    round_: int,
    *,
    mapper_v4: FlowMapper = RandomFlowMapper(DEFAULT_PREFIX_SIZE_V4),
    mapper_v6: FlowMapper = RandomFlowMapper(DEFAULT_PREFIX_SIZE_V6),
    ...
    # random.seed()
    # probe_src_port = random.randint(22000, 25000)
    subsets = subsets_for(
        GetProbesDiff(
