...
from diamond_miner.queries.fragments import cut_ipv6_bit, date_time
from diamond_miner.queries.query import Query, StoragePolicy, results_table, lookup_dict
...
class CreateResultsTable(Query):
    ...
    def statement(
        ...
        (
            ...
            probe_dst_prefix       IPv6 MATERIALIZED {cut_ipv6_bit('probe_dst_addr', self.prefix_len_v6)},
            reply_src_prefix       IPv6 MATERIALIZED {cut_ipv6_bit('reply_src_addr', self.prefix_len_v6)},
