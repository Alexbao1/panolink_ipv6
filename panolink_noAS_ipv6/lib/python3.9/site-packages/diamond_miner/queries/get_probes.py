...
class GetProbesDiff(ProbesQuery):
    ...
    #                 probe_dst_prefix,
    #                 probe_ttl,
    #                 sum(1) as cumulative_probes FROM(
    #                     SELECT
    #                         probe_protocol,
    #                         arrayStringConcat(arraySlice(splitByChar('.', toString(probe_dst_addr)), 1, 3), '.') || '.0' AS probe_dst_prefix,
    #                         probe_ttl FROM {results_table(measurement_id)}
