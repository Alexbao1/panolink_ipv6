...
def weight_table(measurement_id: str) -> str:
    return f"weight__{measurement_id}".replace("-", "_")

def results_table(measurement_id: str) -> str:
    return f"results__{measurement_id}".replace("-", "_")

def asprobes_table(measurement_id: str) -> str:
    return f"asprobes__{measurement_id}".replace("-", "_")

def clusterprobes_table(measurement_id: str) -> str:
    return f"clusterprobes__{measurement_id}".replace("-", "_")

def map_table(measurement_id: str) -> str:
    return f"map__{measurement_id}".replace("-", "_")

def bgp_table(measurement_id: str) -> str:
    return f"bgp__{measurement_id}".replace("-", "_")

def pre_probes_table(measurement_id: str) -> str:
    return f"preprobes__{measurement_id}".replace("-", "_")

def results_view(measurement_id: str) -> str:
    return f"resultsview__{measurement_id}".replace("-", "_")

def group_mapping(measurement_id: str) -> str:
    return f"group_mapping__{measurement_id}".replace("-", "_")

def ttl_filtered_group_mapping(measurement_id: str) -> str:
    return f"ttl_filtered_group_mapping__{measurement_id}".replace("-", "_")
...
def links_view(measurement_id: str) -> str:
    return f"linksview__{measurement_id}".replace("-", "_")
...
class Query:
    ...
    def execute_concurrent(
        ...
        *,
        ...
        with open('/root/Panolink/insertMDA.txt', 'a') as f:
            print(f"  {self.name} {concurrent_requests} insert_mda_probe_counts {measurement_id}", file=f)
